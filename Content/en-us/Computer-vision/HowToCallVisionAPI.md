...
* Step 2: Upload an image and get back tags, description and celebrities
* Step 3: Retrieving and understanding the JSON output from analyze&visualFeatures=tags, description
* Step 4: Retrieving and understanding the JSON output from domain-specific models
* Error Responses
* Summary
...
###Step 2: Upload an image to the Vision API service and get back tags, descriptions and celebrities
...
###Here’s how to get domain-specific analysis (in our case, for celebrities).

**Option 1:** Scoped Analysis - Analyze only a given model
POST https://api.projectoxford.ai/vision/v1.0/models/celebrities/analyze
var celebritiesResult = await visionClient.AnalyzeImageInDomainAsync(url, "celebrities");
For this option, all other query parameters {visualFeatures, details} are not valid.  
If you want to see all supported models, use: 
...
###Step 3: Retrieving and understanding the JSON output for analyze&visualFeatures=Tags, Description
...
###Step 4: Retrieving and understanding the JSON output of domain-specific models
