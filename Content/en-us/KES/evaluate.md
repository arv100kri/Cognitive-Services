...
Typically, an expression will be obtained from a response to the interpret method.  But you can also compose query expressions yourself (see [Query Expression Syntax](Query%20Expression%20Syntax.md)).  
